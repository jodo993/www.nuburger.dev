				...
				switch ( $field['type'] ) { 
					...
					<div class="wip_metabox">
						...
						<div class="input-right">
								...
								<div class="bool-slider <?php if ( suevafree_postmeta($field['id']) != "") { echo stripslashes(suevafree_postmeta($field['id'])); } else { echo "on"; } ?>">
									
									<div class="inset">
										<div class="control"></div>
									</div>
									
									<input name="<?php echo $field['id']; ?>" id="<?php echo $field['id']; ?>" type="hidden" value="<?php if ( suevafree_postmeta( $field['id']) != "") { echo suevafree_postmeta( $field['id']); } else { echo $field['std']; } ?>" class="on-off" />
					...
					<div class="wip_metabox">
						...
						<div class="input-right">
							...
							<input name="<?php echo $field['id']; ?>" id="<?php echo $field['id']; ?>" type="<?php echo $field['type']; ?>" value="<?php if ( suevafree_postmeta( $field['id']) != "") { echo suevafree_postmeta( $field['id']); } ?>" style="width:100%"/>
					...
					<div class="wip_metabox">
						...
						<div class="input-right">
							...
							<select name="<?php echo $field['id']; ?>" id="<?php echo $field['id']; ?>" style="width:100%">
								...
								<option <?php if (suevafree_postmeta( $field['id']) == $option) { echo 'selected="selected"'; } ?> value="<?php echo $option; ?>"><?php echo $values; ?></option><?php } ?>
							</select>
					...
					<div class="wip_metabox">
						...
						<div class="input-right">
						<textarea name="<?php echo $field['id']; ?>" id="<?php echo $field['id']; ?>" type="<?php echo $field['type']; ?>" style="width:100%"><?php if ( suevafree_postmeta( $field['id']) != "") { echo stripslashes(suevafree_postmeta( $field['id'])); } ?></textarea>
						</div>
						<div class="clear"></div>
